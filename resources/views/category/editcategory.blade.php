                ...
                <div class="col-12 mb-30">
                    <div class="pd-20 card-box height-100-p">
                        <div class="profile-info card-box">
                            <h5 class="mb-20 h4 text-blue text-center">Edit Category</h5>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="input-group custom">
                                            ...
                                            <input type="text" class="form-control form-control-lg" placeholder="Enter Your Category name" name="name" value="{{ $category->name }}" >
