                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mb-3 text-right">
                            <a href="{{route('categories.create')}}" class="btn btn-primary btn-rounded">Add Category <i class="fas fa-add"></i></a>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Catgory Name</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{ $item->name }}</td>
                                     <td class="text-center">{{ $item->mainCategory->name }}</td>
                                    <td class="text-center">
                                        <a href="{{ route('categories.show', $item->id) }}" class="btn btn-info sm" title="View Data"><i class="fas fa-eye"></i></a>

                                        <a href="{{ route('categories.edit', $item->id) }}" class="btn btn-info sm" title="Edit Data"><i class="fas fa-pencil-alt"></i></a>

{{--                                        <form action="{{ route('categories.destroy', $item->id) }}" method="POST" style="display:inline-block;" id="deleteForm">--}}
{{--                                            @csrf--}}
{{--                                            @method('DELETE')--}}
{{--                                            <button type="button" class="btn btn-danger" onclick="confirmDelete()"><i class="fas fa-trash-alt"></i></button>--}}
{{--                                        </form>--}}
                                        <form action="{{ route('categories.destroy', $item->id) }}" method="POST" style="display:inline-block;" id="deleteForm_{{ $item->id }}">
                                            @csrf
                                            @method('DELETE')
