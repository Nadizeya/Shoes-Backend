                    ...
                    <div class="col-md-12">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Show Details Category</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="pd-20 card-box height-100-p">
                        <div class="profile-info card-box">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-12 ">
                                    <h5 class=" h3 text-dark text-center">Show Details Category</h5>

                                </div>
                                <div class="col-md-4 col-sm-12 ">

                                    <h2 class="card-title text-primary text-right text-decoration">
                                        <a href="{{ route('categories.edit', $category->id) }}" class="badge badge-primary"> Edit <i class="fas fa-edit"></i></a>
                            ...
                            <div class="container">
                                <div class="row">
                                    ...
                                    <div class="input-group custom">
                                        ...
                                        <input type="text" class="form-control form-control-lg" placeholder="Enter Your SubCategory name" name="name" value="{{ $category['mainCategory']['name'] }}" readonly>
