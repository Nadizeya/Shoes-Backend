    ...
    <div class="pd-ltr-20">
        ...
        <div class="row mb-30">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title text-center">All Main Categories</h3>

                        <!-- Button placed above the DataTable -->
                        <div class="mb-3 text-right">
                            <a href="{{route('main_categories.create')}}" class="btn btn-primary btn-rounded">Add Main Category <i class="fas fa-add"></i></a>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">Main Catgory Name</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('main_categories.show', $item->id) }}" class="btn btn-info sm" title="View Data"><i class="fas fa-eye"></i></a>

                                        <a href="{{ route('main_categories.edit', $item->id) }}" class="btn btn-info sm" title="Edit Data"><i class="fas fa-pencil-alt"></i></a>

{{--                                        <form action="{{ route('main_categories.destroy', $item->id) }}" method="POST" style="display:inline-block;" id="deleteForm">--}}
...
{{--                                        </form>--}}
                                        <form action="{{ route('main_categories.destroy', $item->id) }}" method="POST" style="display:inline-block;" id="deleteForm_{{ $item->id }}">
                                            @csrf
                                            @method('DELETE')
