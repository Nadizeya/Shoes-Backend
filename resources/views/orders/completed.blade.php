    ...
    <div class="pd-ltr-20">
                ...
                <div class="col-md-12">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('order.all')}}">All Orders</a></li>
                            <li class="breadcrumb-item active" aria-current="page">All DeliveredOrders</li>
                        </ol>
                    </nav>
                </div>
            </div>
        ...
        <div class="row mb-30">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title text-center">All Delivered Orders</h3>
                        <div class="d-flex justify-content-end">
                            ...
                            <div class="mb-3 ml-3 text-right">
                                <a href="{{route('order.cancel')}}" class="btn btn-danger btn-rounded">Canceled Orders </a>
                            </div>
                            <div class="mb-3 ml-3 text-right">
