                ...
                <div class="col-12 mb-30">
                    <div class="pd-20 card-box height-100-p">
                        <div class="profile-info card-box">
                            <h5 class="mb-20 h4 text-blue text-center">Add Bank</h5>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        <div class="input-group custom">
                                            ...
                                            <input type="text" class="form-control form-control-lg" placeholder="Enter Your Bank Name" name="bank_name" value="{{ old('bank_name') }}">
                                        ...
                                        <div class="input-group custom">
                                            <div class="input-group-prepend col-md-3">
                                             ...
                                             <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="bank_type" id="accountOption" value="bank_account" required>
                                                <label class="form-check-label" for="accountOption">Bank_Account</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio" name="bank_type" id="paynumberOption" value="pay_number" required>
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="input-group custom">
                                            <div class="input-group-prepend col-md-3">
                                                <span class="input-group-text">Bank Image</span>
                                            </div>
