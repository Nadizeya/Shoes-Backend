                    ...
                    <div class="pd-20 card-box height-100-p">
                        <div class="profile-info card-box">
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-12 ">
                                    <h5 class=" h3 text-dark text-center">Bank Details</h5>

                                </div>
                                <div class="col-md-4 col-sm-12 ">

                                    <h2 class="card-title text-primary text-right text-decoration">
                                        <a href="{{ route('payment_type.edit', $bank->id) }}" class="badge badge-primary"> Edit <i class="fas fa-edit"></i></a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-sm-12 mb-30">
                                        <div class="card text-white bg-light card-box">
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title text-center text-dark"> {{isset($bank->bank_name) ? $bank->bank_name: 'Null'}}</h5>
                                    ...
                                    <div class="col-md-4 col-sm-12 mb-30">
                                        <div class="card text-white bg-light card-box">
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title text-center text-dark"> {{isset($bank->bank_type) ? $bank->bank_type: 'Null'}}</h5>
