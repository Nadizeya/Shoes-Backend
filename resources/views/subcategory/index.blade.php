    ...
    <div class="pd-ltr-20">
        ...
        <div class="row mb-30">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <h3 class="card-title text-center">All SubCategories</h3>

                        <!-- Button placed above the DataTable -->
                        <div class="mb-3 text-right">
                            <a href="{{route('subcategories.create')}}" class="btn btn-primary btn-rounded">Add SubCategory <i class="fas fa-add"></i></a>
                        </div>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center">SubCateory Name</th>
                                    <th class="text-center">Cateory Name</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('subcategories.show', $item->id) }}" class="btn btn-info sm" title="View Data"><i class="fas fa-eye"></i></a>
                                        <a href="{{ route('subcategories.edit', $item->id) }}" class="btn btn-info sm" title="Edit Data"><i class="fas fa-pencil-alt"></i></a>

                                        <form action="{{ route('subcategories.destroy', $item->id) }}" method="POST" style="display:inline-block;" id="deleteForm">
